        ...
        <section
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <input
                    ...
                    required
                    className="w-full sm:flex-1 bg-[#0f172a] border border-slate-700 rounded-2xl px-6 py-4 focus:border-emerald-500 outline-none transition-all text-white"
                />
                <button
                    disabled={status === 'loading'}
                    className="w-full sm:w-auto bg-emerald-500 text-slate-900 font-bold px-8 py-4 rounded-2xl hover:bg-emerald-400 transition-all disabled:opacity-50 whitespace-nowrap"
                >
