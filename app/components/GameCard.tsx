                ...
                <div className="relative p-5 sm:p-6 flex flex-col justify-end bg-slate-900">
                    ...
                    <div className="flex gap-2">
                        ...
                        >
                            <Copy size={20} />
                            {copied && (
                                <span className="absolute -top-8 left-1/2 -translate-x-1/2 text-xs bg-emerald-500 text-white px-2 py-1 rounded">
                                    Copied!
                                </span>
                            )}
                        </button>
                ...
                >
                    ...
                    >
                        <div className="p-4 md:p-6 flex justify-between items-center border-b border-slate-800">
                            <h3 className="text-xl md:text-2xl font-bold text-white pr-4">
                                {game.title}
                            </h3>
                            <button
                                onClick={() => setShowModal(false)}
                        ...
                        >
                            ...
                            <div className="relative z-10 flex flex-col items-center gap-4 transition-transform group-hover:scale-110">
                                <div className="bg-[#ff0000] text-white rounded-2xl p-4 shadow-[0_0_30px_rgba(255,0,0,0.6)]">
