            ...
            <div className="max-w-7xl mx-auto">
                <div className="mb-12">
                    ...
                    <p className="text-slate-400 text-lg italic">
                        ...
                        <span className="text-emerald-500 font-bold">{totalGames}</span> deals have
                        expired.
                    </p>
                </div>

                <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4 md:gap-6 auto-rows-[250px] md:auto-rows-[280px]">
